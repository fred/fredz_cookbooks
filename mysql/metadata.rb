...
attribute "mysql/tunable/thread_cache_size",
  :display_name => "thread_cache_size",
  :default => "4"
attribute "mysql/tunable/thread_concurrency", 
  :display_name => "thread_concurrency",
  :default => "2"
attribute "mysql/tunable/table_cache",
  :display_name => "table_cache",
  :default => "64"
attribute "mysql/tunable/query_cache_size",
  :display_name => "query_cache_size",
  :default => "8M"
attribute "mysql/tunable/query_cache_limit",
  :display_name => "query_cache_limit",
  :default => "2M"
