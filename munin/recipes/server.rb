...
packages = %w{libtest-mock-lwp-perl liblwp2 libdate-manip-perl libnet-snmp-perl liblwp-useragent-determined-perl liblwp-dev libhtml-format-perl libmailtools-perl munin munin-plugins-extra}
